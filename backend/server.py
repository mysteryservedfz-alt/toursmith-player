...
class Page(BaseModel):
    ...
    unlockMode: Optional[str] = None  # None = inherit, "continue", "text", "multiple_choice", "whiteboard", "photo"
...
class Stop(BaseModel):
    ...
    ctaUrl: Optional[str] = None
    # Verification settings
    unlockMode: str = "continue"  # "continue", "text", "multiple_choice", "whiteboard", "photo"
    answer: Optional[str] = None
    caseInsensitive: bool = True  # Case-insensitive answer matching
    # Multiple choice options
    mcOptions: Optional[List[str]] = None  # List of options for multiple choice
